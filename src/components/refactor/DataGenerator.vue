    ...
    <v-container>
        ...
        <template v-else>
            <v-row justify="center" cols="12">
                <v-col sm="10">
                    <v-alert type="info"
                        >Add a column by clicking the + button</v-alert
                    >
                </v-col>
            </v-row>
        </template>
                        ...
                        <v-card-text>
                            <v-row cols="12" dense>
                                ...
                                <v-col sm="12" dense>
                                    First Name:
                                    <code>{{
                                        generator.names.firstName()
                                    }}</code>
                                </v-col>
                                <v-col sm="12" dense>
                                    Last Name:
                                    <code>{{
                                        generator.names.lastName()
                                    }}</code>
                                </v-col>
                                ...
                                <v-col sm="12" dense>
                                    House Number:
                                    <code>{{
                                        generator.address.buildingNumber()
                                    }}</code>
                                </v-col>
                                <v-col sm="12" dense>
                                    Street:
                                ...
                                <v-col sm="12" dense>
                                    State:
                                    <code>{{
                                        this.typeMapping["contact.state"]()
                                    }}</code>
                                </v-col>
                                <v-col sm="12" dense>
                                    Postcode:
                                    <code>{{
                                        generator.address.postCode()
                                    }}</code>
                                </v-col>
                                <v-col sm="12" dense>
                                    Country:
                                ...
                                <v-col sm="12" dense>
                                    Gender
                                    <code>{{
                                        this.typeMapping["contact.gender"]()
                                    }}</code>
                                </v-col>
                                <v-col sm="12" dense>
                                    DOB YYYY-MM-DD:
                                    <code>{{
                                        this.typeMapping["dob.yyyy-mm-dd"]()
                                    }}</code>
                                </v-col>
                                ...
                                <v-col sm="12" dense>
                                    TSB User ID:
                                    <code>{{
                                        this.typeMapping["banking.tsbUserID"]()
                                    }}</code>
                                </v-col>
                                <v-col sm="12" dense>
                                    TSB Password:
                                ...
                                <v-col sm="12" dense>
                                    Username
                                    <code>{{
                                        this.typeMapping["internet.username"]()
                                    }}</code>
                                </v-col>
                                <v-col sm="12" dense>
                                    Password
                                    <code>{{
                                        this.typeMapping["internet.password"]()
                                    }}</code>
                                </v-col>
                                ...
                                <v-col sm="12" dense>
                                    Form Image X
                                    <code>{{
                                        this.typeMapping["padding.FormImageX"]()
                                    }}</code>
                                </v-col>
                                <v-col sm="12" dense>
                                    Form Image Y
                                    <code>{{
                                        this.typeMapping["padding.FormImageY"]()
                                    }}</code>
                                </v-col>
        ...
        data() {
            return {
                ...
                typeMapping: {
                    ...
                    "internet.password": () => {
                        return this.generator.internet.password(12);
                    },
                    ...
                    "banking.accountType": () => {
                        ...
                        let type = this.generator.random.number(
                            0,
                            types.length - 1
                        );
                        return types[type];
